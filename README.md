...
## Features
- Responsive and accessible calculator UI with persistent history and memory functions.
...
- The calculator persists theme and history in `localStorage`; no PII is stored.
